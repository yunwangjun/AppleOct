...
function(_y) {
  ...
  function(a) {
    return String(arguments.length == 0 ? "": a)
  },
...
new function () {
  new base2.Package(this, {imports: "Function2,Enumerable"});
  eval(this.imports);
  var i = RegGrp.IGNORE;
  var S = "~";
  var A = "";
  ...
  var v = Base.extend({
    constructor: function (a, c, d) {
      ...
      this.encoder = c
    }, parser: null, encoder: Undefined, search: function (c) {
      var d = new B;
  ...
  }, {IGNORE: {CONDITIONAL: i, "(OPERATOR)(REGEXP)": i}, PATTERN: /\b_[\da-zA-Z$][\w$]*\b/g});
  var q = v.extend({
    encode: function (d) {
      var b = this.search(d);
      b.sort();
  ...
  global.Packer = Base.extend({
    constructor: function () {
      ...
      this.privates = new w;
      this.base62 = new q
    }, minifier: null, shrinker: null, privates: null, base62: null, pack: function (a, c, d, b) {
    ...
    data: new p({"STRING1": i, 'STRING2': i, "CONDITIONAL": i, "(OPERATOR)\\s*(REGEXP)": "$1$2"}),
    encode52: function (c) {
      function d(a) {
  ...
  }, {ENCODED_DATA: /\x01(\d+)\x01/g, PREFIX: "\x02", SHRUNK: /\x02\d+\b/g})
};